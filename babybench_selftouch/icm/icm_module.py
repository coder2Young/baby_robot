...
class ICMModule(nn.Module):
    ...
    def __init__(self, 
        ...
        # Inverse model initialized, but deprecated in this version
        ...
        # EMA also deprecated in this version
    ...
    def train_on_batch(self, 
        ...
        # Note: Inverse model is not used in this version, so we skip its training
        # Disable inverse model now
        beta_icm = 1.0 
        w_proprio_vae = 1.0
        w_touch_vae = 5.0
        w_icm = 1.0
        ...
        for epoch in range(n_epochs):
            epoch_losses = {
                ...
                'forward_loss': [],
                #'inverse_nll_loss': [] # This is deprecated in this version
            }
            ...
            for i in range(0, dataset_size, batch_size):
                ...
                # 1. & 2. VAE encoding and loss calculation
                (z_combined, 
                 (proprio_recon, p_mu, p_logvar), 
                ...
                # 5. Calculate Inverse Model loss using the new model ---
